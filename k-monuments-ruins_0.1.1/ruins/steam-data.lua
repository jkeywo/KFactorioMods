...
data:extend(
{
  ...
  },
  {
    ...
    icon = "__k-monuments-ruins__/graphics/steam_geyser.png",
  ...
  },
  {
    ...
    animation =
    {
      filename = "__k-monuments-ruins__/graphics/steam_geyser.png",
      priority = "high",
      width = 96,
      height = 96,
      frame_count = 1,
  ...
  },
  {
    ...
    icon = "__k-monuments-ruins__/graphics/steam_geyser_pump.png",
    flags = {"placeable-neutral"},
    max_health = 300,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    ...
    animation =
    {
      filename = "__k-monuments-ruins__/graphics/steam_geyser_pump.png",
      width = 122,
      height = 107,
      frame_count = 1,
      line_length = 1,
