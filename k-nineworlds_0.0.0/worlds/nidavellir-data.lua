...
data:extend(
{
  ...
  },
  {
    ...
    layer = 25,
    autoplace = world_autoplace_settings("nidavellir", "nidavellir-floor", {{{35, 0.8}, {0, 0.4}}}),
    variants =
    {
      main =
      {
  ...
  },
  {
    ...
    layer = 70,
    autoplace = world_blockage_autoplace_settings("nidavellir", "nidavellir-wall", 250),
    variants =
    {
      main =
      {
...
{
  {
    ...
    {
      hardness = 1,
      mining_particle = "ne-nifite-particle",
      mining_time = 1.5,
      result = "nw-nifite-ore"
    },
    ...
    autoplace =
    {
      ...
      richness_base = 500,
      tile_restriction = { "nidavellir-floor" },
      peaks = 
      {
        {
          noise_layer = "nw-nifite-ore",
